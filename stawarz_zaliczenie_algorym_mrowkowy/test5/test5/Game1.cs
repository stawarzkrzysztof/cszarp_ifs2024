...
public class Game1 : Game
{
    ...
    // model constants
    private const int nodeCount = 75; // max 100 cuz slow
    ...
    private float lineWidth = .5f; // work with line width 
    ...
    private bool wannaDropTablesOnStart = true; // <--------------------------------------------------------------------
